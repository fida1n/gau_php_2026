...
(1, 'narimani kurbanovi', 'bachoooo@mail.ru', '56745765', 'kazarma'),
(2, 'vato', 'wripa@gau.edu.ge', '45363465', 'kaxeti'),
(3, 'dato', 'dato@gau.edu.ge', '34234325435', 'avlabari');
...
(1, 'lika', 'Loan Officers', 'batumi branch'),
(2, 'levani', 'Bank Tellers', 'ozurgeti branch'),
(3, 'tiko', 'Credit Analysts', 'vake branch');
